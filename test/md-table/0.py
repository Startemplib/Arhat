...
result = table_mdTexcel(
    r"C:\5Startemplib\Arhat\test\md-table\EDFA-Thorlabs-S.md",
    r"C:\5Startemplib\Arhat\test\md-table\Data.xlsx",
    r"C:\5Startemplib\Arhat\test\md-table\Readme.txt",
    mark_keyword="mark",
)
